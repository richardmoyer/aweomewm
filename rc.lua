...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey },            "space",     function () awful.util.spawn("rofi -show drun -show-icons") end,
              {description = "Launch Rofi", group = "Richm"}),

    -- awful.key({ modkey },            "~",     function () awful.util.spawn("emacsclient --eval "(emacs-everywhere)"") end,
    --           {description = "Emacs Everywhere", group = "Richm"}),
    -- Dmenu
    -- awful.key({ modkey },            "space",     function () awful.util.spawn("dmenu_run") end,
    --           {description = "Launch Dmenu", group = "Richm"}),

    -- Firefox
    awful.key({ modkey },            "b",     function () awful.util.spawn("firefox") end,
              {description = "Firefox", group = "Richm"}),

    -- Emacs
    awful.key({ modkey },            "e",     function () awful.util.spawn("emacs") end,
              {description = "Emacs", group = "Richm"}),
